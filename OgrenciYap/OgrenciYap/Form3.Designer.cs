namespace OgrenciYap
{
	partial class Form3
	{
		...
		private void InitializeComponent()
		{
			...
			this.label1.Text = "3000 Yılına kadar lisanslıdır.";
			// 
			// label2
			// 
			...
			this.label2.Text = "EXC turnike sistemlerinin tüm haklarını Ömer Fatih AĞIN kendi üzerinde tutar ";
			// 
			// label3
			// 
			...
			this.label3.Size = new System.Drawing.Size(256, 73);
			...
			this.label4.Text = "Lisans No: 011220191";
			// 
			// Form3
			// 
