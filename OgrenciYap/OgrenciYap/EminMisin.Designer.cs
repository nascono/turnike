namespace OgrenciYap
{
	partial class EminMisin
	{
		...
		private void InitializeComponent()
		{
			...
			this.button2.Text = "Onaylamıyorum";
			...
			this.label1.Text = "Bu yıl mezun olanların hepsini silmeyi onaylıyormusunuz(Hazirandan önce yapmayın)" +
    "";
			// 
			// EminMisin
			// 
